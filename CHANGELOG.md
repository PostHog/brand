...
- 8912022: Sync brand assets from Figma (1 removed).
...
- 7676037: Sync brand assets from Figma (6 added, 2 removed).

  **hoggies**

  - Added 6: Burning Money, Explorer, Level Up, Mailbox, Safari, Two Player
  - Removed 2: Business Evolution, Quick Call
  - Updated 87: Bat, Business Evolution, Cake, Card, Caribana, Caveman, Cereal, Code Bubble, Coffee Cup, Coffee Run, Construction 1, Construction 2, Cursor, Dadd-ai 1, Data Thief, Desk Wizard, Director, Dj, Doll House, Drake Nah, Drake Yah, Driving Hogzilla, Dynamite, Evel, Experiment, Float, Football Coach, Gardener 2, Gravedigger, Greek, Hand Clasp, Hipster, Hogpatch, Honey, Hoot, Jack Dawson, Lemon Wrangler 1, Lemon Wrangler 2, Lemon Wrangler 3, Magnifying Glass 2, Money, Mountie, Mr Potato Head 1, Mr Potato Head 2, Noir 4, Office Worker, Oprah, Organized, Panic, Piñata, Puzzle, Reading, Reading Is Magic, Remote Work, Robot, Rocket, Roller Coaster, Rose, Sailor, Scientist, Scorpion, Sitting, Soapbox, Soccer Coach, Speaker 1, Speaker 2, Stamp Approved, Stamp Denied, Star, Sunburn, Superhero, Surfer, Survey, Swimmer 1, Swimmer 2, Terminator, The Bride, Traffic Controller, Traffic Police, Transformer, Waiter, Will Smith, Wizard 1, Wizard 2, Wizard 5, Workflows, X-ray
